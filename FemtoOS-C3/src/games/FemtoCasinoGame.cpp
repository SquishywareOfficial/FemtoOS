...
FemtoCasinoGame::FemtoCasinoGame(uint32_t width, uint32_t height, uint32_t left)
    : App("Femto Casino", width, height), left_(left) {}
...
void FemtoCasinoGame::updateRunning(uint32_t deltaMs, const ButtonInput& input) {
  ensureLoaded();
...
void FemtoCasinoGame::drawFrame(U8G2& u8g2, const char* title) {
  u8g2.drawFrame(0, 0, width + 2, height);
  u8g2.setFont(u8g2_font_5x8_tr);
  u8g2.drawStr(3, 8, title);
}

void FemtoCasinoGame::drawMoney(U8G2& u8g2, int x, int y, const char* label, Casino::Money value) {
  char amount[10];
...
void FemtoCasinoGame::drawCardLine(U8G2& u8g2, int x, int y, const uint8_t* cards, uint8_t count, uint8_t visibleCount) {
  char label[4];
  u8g2.setFont(u8g2_font_4x6_tr);
...
void FemtoCasinoGame::drawBlackjackCards(U8G2& u8g2, int x, int y, const uint8_t* cards, uint8_t count, bool hideFirst) {
...
void FemtoCasinoGame::drawStart(U8G2& u8g2) {
  ensureLoaded();
...
void FemtoCasinoGame::drawRunning(U8G2& u8g2) {
  ensureLoaded();
...
void FemtoCasinoGame::drawHub(U8G2& u8g2) {
  drawFrame(u8g2, "Casino");
  u8g2.setFont(u8g2_font_5x8_tr);
...
void FemtoCasinoGame::drawBlackjack(U8G2& u8g2) {
...
void FemtoCasinoGame::drawRoulette(U8G2& u8g2) {
...
void FemtoCasinoGame::drawSlots(U8G2& u8g2) {
...
void FemtoCasinoGame::drawHoldem(U8G2& u8g2) {
...
void FemtoCasinoGame::drawVideoPoker(U8G2& u8g2) {
...
void FemtoCasinoGame::drawBroke(U8G2& u8g2) {
...
void FemtoCasinoGame::drawCashOut(U8G2& u8g2) {
...
void FemtoCasinoGame::drawEnd(U8G2& u8g2) {
  drawFrame(u8g2, "Casino");
  u8g2.setFont(u8g2_font_5x8_tr);
